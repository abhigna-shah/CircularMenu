/**
 * Circular Menu
 * Filename: CircularMenu CircularMenu.js
 * created on 8 Mar 2020
 * 
 * Purpose: A custom component for displaying circular menu   
 */
...
import CircularMenuItem from './CircularMenuItem';
  ...
  /**
   *  An object having positions for menu
   */
  const alignMap = {
  ...
  /**
   * A custom component for displaying circular menu
   *
   * @export
   * @class CircularMenu
   * @extends {Component}
  ...
  export default class CircularMenu extends Component {
    ...
    /**
     * Lifecycle method - Called when unmounted
     * @param {*} props 
     */
    ...
    renderButton() {
      return (
        <View
          style={this.getCircularMenuButtonStyle()}
        >
          <TouchableOpacity
            activeOpacity={0.85}
  ...
  CircularMenu.Item = CircularMenuItem;
  ...
  CircularMenu.propTypes = {
    ...
    position: PropTypes.oneOf(['left', 'center', 'right','topLeft', 'topRight', 'topCenter', 'middleLeft', 'middleRight']),
  };
  ...
  /**
   * Styles required for circular menu
   */

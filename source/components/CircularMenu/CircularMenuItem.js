/**
 * Circular Menu
 * Filename: CircularMenu CircularMenuItem.js
 * created on 8 Mar 2020
 * 
 * Purpose: A custom component for displaying circular menu item.   
 */
...
/**
 * A custom component for displaying circular menu item.
 *
 * @export
 * @class CircularMenuItem
 * @extends {Component}
 */
export default class CircularMenuItem extends Component {
  ...
  /**
   * Styles required for circular menu item
   */
